...
module.exports = async (req, res) => {
    ...
    if (req.method === 'GET') {
        ...
        try {
            ...
            // PATCH KHUSUS SILICONFLOW: Wajib pakai POST dan kirim Request ID
            if (statusUrl.includes('siliconflow')) {
                fetchOptions.method = 'POST';
                fetchOptions.body = JSON.stringify({ requestId: taskId });
                statusUrl = activeProvider.baseUrl + "/v1/video/status";
            }
